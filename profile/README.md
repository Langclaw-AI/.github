...
| Path | Stack | Port | README |
| ---- | ----- | ---- | ------ |
| [`frontend/`](frontend/) | Next.js 16, React 19, RainbowKit, AI SDK | 3000 | [frontend/README.md](frontend/README.md) |
| [`backend/`](backend/) | Node HTTP API, TypeScript, Supabase | 3001 | [backend/README.md](backend/README.md) |
| [`contracts/`](contracts/) | Foundry, `LangclawUsageVault` | — | [contracts/README.md](contracts/README.md) |
...
OpenClaw skills: [`backend/openclaw/skills/`](backend/openclaw/skills/). Install: [OpenClaw docs](https://docs.openclaw.ai/install).
...
Full spec: [`backend/docs/API_REFERENCE.md`](backend/docs/API_REFERENCE.md).

## Smart contracts (0G mainnet, chain ID `16661`)

| Contract | Location | Purpose |
| -------- | -------- | ------- |
| **LangclawUsageVault** | [`contracts/`](contracts/) | Native 0G deposits; backend-authorized withdrawals |
| **SignalGraphRegistry** | [`backend/contracts/SignalGraphRegistry.sol`](backend/contracts/SignalGraphRegistry.sol) | `registerBrief(hash, storageUri)` for research proof |
...
| Supabase | Apply `backend/supabase/migrations/*.sql` |
...
See env templates: [`backend/.env.example`](backend/.env.example), [`frontend/.env.example`](frontend/.env.example), [`contracts/.env.example`](contracts/.env.example).
...
Spec for vault requirements: [`backend/docs/SMART_CONTRACT_TEAM_NOTES.md`](backend/docs/SMART_CONTRACT_TEAM_NOTES.md).
...
| -------- | ----------- |
| [`backend/docs/API_REFERENCE.md`](backend/docs/API_REFERENCE.md) | Full HTTP API |
| [`backend/SIGNALGRAPH_BLUEPRINT.md`](backend/SIGNALGRAPH_BLUEPRINT.md) | Hackathon blueprint |
| [`backend/docs/DEMO_SCRIPT.md`](backend/docs/DEMO_SCRIPT.md) | 3-minute demo script |
| [`backend/openclaw/README.md`](backend/openclaw/README.md) | OpenClaw workspace |
